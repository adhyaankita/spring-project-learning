...
import com.sample.database.databasedemo.springdata.PersonSpringDataRepository;
...
public class SpringDataDemoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		logger.info("Update 10003 -> {}", repository.save(new Person(10003, "Peter", "Utrecht", new Date())));
